...
" L8--est_Revision#0: 2026 Apr 07
" d8VS='Q47MCmnt'; 2du:Dtect more common dateTimeZone 4m@z && let thM contain the (Da|Mo)Nam&&YrJK,thN tImez&&zOnez, colr sub-fEldz of URLz && UnderCurl thM,
...
sy    keyword du2Octl gst123 g3 dict dic wh8 wh64 wheo d8ok lsd8 bak calN ncal tstn reso resp gnp8 Prmz Sumz Fibz Fctz qbix
...
sy    match   du2Stg1 "\(^\| \)\^\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg2,du2Stg3,du2Stg4,du2Stg5,du2Stg6,du2Stg7
sy    match   du2Stg2 "\(^\| \)\-\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg3,du2Stg4,du2Stg5,du2Stg6,du2Stg7
sy    match   du2Stg3 "\(^\|\s\)+\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg4,du2Stg5,du2Stg6,du2Stg7
sy    match   du2Stg4 "\(^\| \)\*\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg5,du2Stg6,du2Stg7
sy    match   du2Stg5 "\(^\|\s\)%\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg4,du2Stg6,du2Stg7
sy    match   du2Stg6 "\(^\|\s\)$\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V]\([^;]*\|\n*\)*;" contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg4,du2Stg5,du2Stg7
sy    match   du2Stg7 "\(^\|\s\)#\(\s\+\|[-+*%$#\^]\)[0-9A-Za-z._][1-9A-C][1-9A-V][^;]*;"           contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg4,du2Stg5,du2Stg6,du2dur8,du2owhu contained
" above single-line contained for comment sepR8ion from und8d comments;
...
sy    match   du2YrJK     "\<\(\(18\|19\|20\|21\)\d\d\|[Yy]ear\)s\?\>"
...
sy    match   du28let                                     "8[0-9A-Za-z._]\{-}\>"                                contained contains=du28ion,du28suf
sy    match   du28wpl                             "[A-Za-z]8[0-9A-Za-z._]\{-}\>"                                contained contains=du28let
sy    match   du28wrd          "\<[-_0-9A-Za-z]\{-}[A-Za-z]8[0-9A-Za-z._]\{-}\>"                                          contains=du28wpl
sy    match   du2PMod "\.[Ppt][Llmo]\?[d6]\?\>" " attempt to get dur8 from ~/dox/2du/know.ls && ~/dox/subs/*.subs 2 colr back thru d8bo;
sy    match   du2ofow                          "\<\(of\|on\|with\|\(do\|cover\|explain\)ing\)\>"                contained
sy    match   du2owhu     "\<of \([0-9A-Za-z._]\+\) \?\(on\|with\|\(do\|cover\|explain\)ing\)\?\>"              contained contains=du2ofow
sy    match   du2dpHS                                                       "[0-9A-Za-x]\{2}"he=s+2,ms=s+1      contained
sy    match   du2dsEC                                                       "[0-9A-Za-x]\{3}"he=s+2,ms=s+1      contained contains=du2dpHS
sy    match   du2dmIN                                                       "[0-9A-Za-x]\{4}"he=s+2,ms=s+1      contained contains=du2dsEC
sy    match   du2dhOR                                                    ":\?[0-9A-Za-x]\{4}"he=s+2,ms=s+1      contained contains=du2dmIN
sy    match   du2dur8               "\(:\|{\)[0-9A-Za-z._]\?[0-9A-Za-z._]\{3}}\?\>"                                       contains=du2dhOR
...
sy    match   du2Cmnt  "^#.*"                                    contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg4,du2Stg5,du2Stg6,du2Stg7,du2StrD,du2StrS,du2Quot,du2dur8
sy    match   du2Cmnt "\s#.*"hs=s+1                              contains=@Spell,du2Octl,du2Todo,du2URLz,du24wdS,du2BakS,du2DCSC,du2Type,du2Prns,du2d8,du2YMDz,du2YrJK,du2MNam,du2DNam,du2PthS,du2Stg1,du2Stg2,du2Stg3,du2Stg4,du2Stg5,du2Stg6,du2Stg7,du2StrD,du2StrS,du2Quot,du2dur8
...
hi  def link du2dhOR User5
hi  def link du2dmIN User6
hi  def link du2dsEC User7
hi  def link du2dpHS User8
...
hi  def link du2ofow Special
hi  def link du2owhu Operator
