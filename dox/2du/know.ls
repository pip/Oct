...
N28L5prm:HTTPS://YouTu.be/OpaKpzMFOpg "A Fibonacci-like Way to Make Primes, and a Tale of Logarithmic Scale" # N1K:0MG0 of EricRowland explaining a recurrence;
N2ILEdog:HTTPS://YouTu.be/sF03FN37i5w "Exposing Scientific Dogmas - Banned TED Talk - Rupert Sheldrake" # N1H:0HV0 of AfterSkool gr8 dry-erase marker anim8ion;
N4BMEqua:HTTPS://YouTu.be/-UrdExQW0cs "How Quantum Computers Break the Internet… Starting Now" # N3K:0OS0 of Veritasium describing quantum primes factoriz8ion;
N4BMFNFN:HTTPS://YouTu.be/UDQjn_-pDSs "Why 7 is Weird" # M8M:0C20 of NumberPhile's Dr.JamesGrime explaining ($rest + 5*$last) or ($rest - 2*$last) % 7 can then
#   be repeated to determine if a huge number is evenly divisible by 7. He also goes over testing 1..11 with an altern8ing sum of example 6468 as (6-4+6-8)%11;
N4BMGrbx:HTTPS://YouTu.be/wL3uWO-KLUE "The Trick That Solves Rubik’s Cubes and Breaks Ciphers (Meet in the Middle)" # M25:0EG0 of PolyLog mentions Cube20.Org;
N4CM1Api:HTTPS://YouTu.be/EK32jo7i5LQ "Why Do Prime Numbers Make These Spirals? | Dirichlet’s Theorem, Pi Approximations, and More" # JA8:0MK0 of 3Blue1Brown;
N4CM1phi:HTTPS://YouTu.be/CaasbfdJdJg "Infinite Fractions and the Most Irrational Number" # G7U:0DS0 of Mathologer on π && phi with r8ioz as finite fractionz;
N4CM8prm:HTTPS://YouTu.be/1Osh9MPk4Hw "How to Find the Biggest Primes" # M9C:0JJ0 of jHan discussing the Gr8Internet Mersenne.Org PrimeSearch && PrimeGrid.Com;
N53ME8HD:HTTPS://YouTu.be/Ae9EKCyI1xU "GradIEEEnt Half Decent: The Hidden Power of Imprecise Lines" # N51:0t10 of SuckerPinch channel's TomMurphy VII [7] from
#   ImpracticalEngineering on using 16-bit (half-precision) floating-point values with exclusively linear oper8ions (comprised of just addition, multiplic8ion,
#   && accumul8d float rounding errors by constants) for Machine Learning && showing that any complex non-linear oper8ion can be made from simple linear onez;
N53MKTUX:HTTPS://YouTu.be/DzNmUNvnB04 "TMux Has Forever Changed the Way I Write Code" # N4P:0DT0 of 'Dreams of Code' explaining .conf file && using tmux&&nvim;
N53MMbAI:HTTPS://YouTu.be/FdldD0-kEcc "The Vowel Space" # N4M:0K60 of DrGeoffLindsey going over phonetics of various language pronunC8ionz && mapping to colrz;
N57MK8No:HTTPS://YouTu.be/w-PvDbQcztc "Why Souls Are Nonsense" # N55:0HB0 of TMM (TheMessianicManic) criticizing the guest of a CosmicSkeptic video about soul;
N6FMFREE:HTTPS://YouTu.be/TI5FMj5D9zU "I don't believe in free will. This is why." # N63:0Jw0 of SabineHossenfelder explaining deterministic plus random brain;
N6LMAI4U:HTTPS://YouTu.be/MKTNdUeo2f0 "Open-Source Wins Again" # N6C:08N0 of MarkMcNally on 2023's OS LargeLanguageModel developments around OpenAI's ChatGPT.
# N2O:Meta launches LLaMa (LargeLanguageModelMetaAI) N33:leaked, N3D:Stanford's Alpaca && Alpaca-lora adds LLaMa instruction tuning && training within hours on
#   a single RTX4090 (lora on a laptop?), N3I:fast on CPU (no GPU), N3J:Vicuna is released training for $300 (using ShareGPT), N3P:Nomic crE8z GPT4All model &&
#   ecosystem with training for just $100,StableDiffusion (OpenSourceImageGener8ion) seems to be surpassing OpenAI's Dall-E (which is stagn8ing in popularity);
N6LMBart:HTTPS://YouTu.be/GJPnuL8fL7E 'Apologist Exposes "Invincible Ignorance" of Bart Ehrman\'s "Philosophical Drivel" on Resurrection' # N6D:0UI0 Paulogia;
N6LMBrn3:HTTPS://YouTu.be/A4_GpSok5VI "You Have 3 Brains. This is How to Use Them | Robert Sapolsky" # N62:07h0 of TheWell on 0Reptilian, 1Limbic, && 2Cortex;
N6LMHow2:HTTPS://YouTu.be/S8AhH2UDtj8 "How to Move On When Your Passion Becomes Impossible" # N4M:0Bg0 of DrWaku on how to deal with pain/disease changing you;
N6LMIRRA:HTTPS://YouTu.be/-qeoxFdpoLg "Theism is IRRATIONAL... Here's Why" # N61:07i0 of RationalityRules recapping theism talk given @TheAlesburyValeAcademy;
N6OMEGAP:HTTPS://YouTu.be/TbzZIMQC6vk "Did AI Prove Our Proton Model Wrong?" # N6L:0Gu0 of PBSSpaceTime discussing electron collisions scattering charm quarks:
N6QMCOrc:HTTPS://YouTu.be/KoI6G7oWYvM "New 'Orca' Open-Source Model Surprised Everyone" # N69:0Jb0 of MatthewBerman detailing paper && progress from MicroSoft;
N6QMD1NP:HTTPS://YouTu.be/R33RoMO6xeA "Is 1 a Prime Number?" # MAK:0PL0 of AnotherRoof with gr8 history of numbers && primes from Antiquity,&&Medieval,2Modern;
N74MIGHT:HTTPS://YouTu.be/rnIQFI1pYLM "Debate: Theism vs Naturalism | Jonathan McLatchie vs Alex O'Connor" # M5P:2P40 of CosmicSkeptic (Alex) presenting God's
#   hiddenness, geographical statistics predicting religion, && the problems of both great && meaningless suffering of humans/animals alike while Dr. McLatchie
#   described the irreducible complexity of DNA/RNA replic8ion with high inform8ion content being assoC8d with intelligence && Jesus' resurrection as probable;
N7AMBibl:HTTPS://YouTu.be/pHelPSTlb-0 "The Bible's Ultimate Problem - Sam Harris vs Jordan Peterson" # N59:0FV0 of PangBurn gr8 deb8 moder8d by Bret Weinstein;
N7NM6Z8a:HTTPS://YouTu.be/l9tPL8bKty8 "The Best and Easiest Way To Do F2L: Zeta-Slotting" # N7I:0Bm0 of TheCuber explaining way simpler method than Full F2L!;
N7NMExis:HTTPS://YouTu.be/8HoNJVNbcS0 "6 Proofs for God's Existence" # N7D:0Q20 of Paulogia breaking down KyleButt's intuition-based appeal to God's existence;
N7PMCBld:HTTPS://YouTu.be/BL4DCEp7blY "How to Build a PC, the Last Guide You'll Ever Need!" # M4H:1g40 of LinusTechTips which I should watch B4 mkng my new PC;
N8AM6Exc:HTTPS://YouTu.be/PcAXkfH2j9w "WOTMQ: Excuses, Excuses" # N82:05F0 of MisterDeity saying apologists should be called excusegists && calling on skeptic
#   channels to follow: StephenWoodford, PineCreekDoug, ShannonQ, JimmySnow, AronRa, NathanOrmond, JamesFedor, TheNonAlchemist, ChristyBurke, MindShiftBrandon,
#   MythVisionDerek, SirSic, JaquelineGlenn, HolyKoolAid, AlexO'Connor, OwenMorgan, GodlessGranny, TJump, MattDillahunty, TheSkeptic, BettyBowers, SethAndrews,
#   TMM, everyone at the MajorityReport, && Paulogia. Mr.D. asked why if Adam's sin brought death instantly,why didn't Jesus' redemption instantly stop death?;
N8AM6blv:HTTPS://YouTu.be/DQxtWfYT1rU "Why We Shouldn't Believe in a Soul" # N7R:0A10 of TheMessianicManic using BartEhrman to argue against WilliamLaneCraig;
N8CM2Dev:HTTPS://YouTu.be/IiuWlqabx9M "How to Become a DevOps Engineer in 2023? | Skills to Learn" # N25:0KX0 of TravisMedia recommending lists of things to do
#   && learn in order to get hired into DevOps. Linux, Git, Scrum (Agile), && standard (Perl) development (he recommends Python) I already know a lot about...
#   but then I should get an AWS Solutions Architect AssoC8 Certific8ion, learn Kubernetes (&& Docker more), TerraForm or CloudForm8ion (InfrastructureAsCode),
#   Ansible (Configur8ionManagement), Jenkins or AWS CodeCommit/Build/Pipeline (Autom8TestingCI/CD), && ELC (ElasticsearchLogstashCabana) Splunk (Monitoring);
N8DMNnow:HTTPS://YouTu.be/irEsvzgzcZU "Most UnderRated Game Engines" # N8A:0CL0 of GameFromScratch highlighting several altern8ive game-engines to ck&&try out;
N8EMGWC5:HTTPS://YouTu.be/C1rQQ_YpgcI "How to Not Suck at Color - 5 Color Theory Tips Every Designer Should Know" # L3U:07p0 of TheFuturAcademy gr8 help tips;
N8EMIVoc:HTTPS://YouTu.be/vhArHsfsLAQ "The 'Voice Cloning AIs' They Never Tell You About (and How They Work)" # N88:0Gs0 of ByCloud on RVC, TorToiSe,&& 11Labs;
N8HMASC6:HTTPS://YouTu.be/6Txmxask30I "The Inevitable Downfall of SoulCalibur" # N76:09Q0 of NerdstalgicGaming following the dying history of Souls && Swords;
N8QMGRst:HTTPS://YouTu.be/vL2nB1VwX1M "I Spent Six Months Rewriting Everything in Rust" # N8F:0FA0 of ChrisBiscardi showing off his HTTPS://RustAdventure.Dev;
N8QMIrgb:HTTPS://YouTu.be/gnUYoQ1pwes "The Amazing Math Behind Colors!" # M8C:0gX0 of KuvinaSaydaki with gr8 explan8ion of everything colors && cnv RGB to HSV;
N8UMDiff:HTTPS://YouTu.be/tRaq4aYPzCc "Mathematicians Use Numbers Differently From The Rest of Us" # N66:0X50 of Veritasium with gr8 coverage of p-adic numbs;
N8UMGolf:HTTPS://YouTu.be/JYN25TeM5kI "Nicer Trees Spend Fewer Bytes" # N8I:09r0 of DavidRenshaw discussing Golf.Horse techniques of compressing Wordle words;
N8UMFont:HTTPS://FaultLore.Com/blah/text-hates-you "Gr8 FireFox Developer's BreakDown on Text, Fonts, Styling, Layout, Shaping, Rasterization, && Composition"
# Text: Scalars (CodePoints), Characters (ExtendedGraphemeClusters), Glyphs, Lig8ures (several Scalars [or even Characters] comprising single font character),
#   && Emoji (full-colored Glyphs), Font: [document mapping Characters to Glyphs], Script (Glyph-set of a language), CursiveScript (touching Glyphs that flow
#   together, like Arabic), Color (RGB && Alpha values for Fonts), Style (Bold && Italics modifiers plus hinting, aliasing, && other settings cram together);
N9AMKnot:HTTPS://YouTu.be/8DBhTXM_Br4 "How The Most Useless Branch of Math Could Save Your Life" # N93:0ZK0 of Veritasium covering gr8 history of knot-theory;
N9AMLITE:HTTPS://YouTu.be/QCX62YJCmGk "This Demo Tests Your Understanding of Light | Barber Pole, Part 1" # N91:09u0 of 3Blue1Brown explaining polarized lite;
N9AMLite:HTTPS://YouTu.be/aXRTczANuIs "Origin of Light, Scattering, && Polariz8ion | Barber Pole, Part 2" # N91:0LW0 of 3Blue1Brown on more sugar-water chiral;
N9NM9Ecl:HTTPS://YouTu.be/inMPbM6Rsl8 "Yes, This Is How We Know The Earth Is Slowing Down" # N9M:0480 of MinuteEarth on our Sun's corona && upcoming eclipses;
N9NMIEsc:HTTPS://YouTu.be/3T2Al3jdY38 "DEF CON 31 - Weaponizing Plain Text ANSI Escape Sequences as a Forensic Nightmare - STÖK" # N9F:0eU0 of DEFCONConference
#   present8ion on all sorts of ways to use escape codes to inject commands which can exfiltr8 d8a from machines && insert troubling info in system log files;
NA1MAGES:HTTPS://YouTu.be/fv-wlo8yVhk "Your Colors Suck (It's Not Your Fault)" # N9U:0b00 of Acerola explaining sRGB, XYZ, HSL, HSV, CIELAB, && Bjorn's OKLAB;
NA5M1Vim:HTTPS://YouTu.be/CEMPq_r8UYQ "A Powerful Way to Make Editing Code in NeoVim Even Better" # NA4:0Hk0 of JoseanMartinez key-mapping TreeSitter tXtobjX;
NAFMLPr0:HTTPS://YouTu.be/8Ab3ArE8W3s '"Stop Writing Dead Programs" by Jack Rusher (Strange Loop 2022)' # MAB:0j30 of StrangeLoopConference gr8 talk about TTY
#   80-column && punch-card compatibility maintained today as well as tons of gr8 languages && fE8ures to learn from (e.g., live-coding && GUI interactivity);
NB2M4Art:HTTPS://YouTu.be/KS837a-TFRc "Insanely Smooth Pixel Attack Anim8ion Tutorial" # NA5:0Ir0 of Penusbmic in Aseprite kEyfrAming cool pixL-Rt swordslash;
NBCL4Net:HTTPS://YouTu.be/4btW5x_clpg "Meet NetBoot.XYZ - NetWork Boot Any Oper8ing System" # NBB:0Ox0 of TechnoTim on booting tons of OS's && Recovery imagez;
NBMLDout:HTTPS://YouTu.be/GtCoZGLTeKw "Even Christians Think the Soul Is a Silly Idea" # NBJ:0AO0 of TheMessianicManic asking a lot of good questions on soul;
NBNL4Wik:HTTPS://YouTu.be/InGeRuRk3f8 "The Perfect Sorting Algorithm? Block Sort Explained (Wiki Sort, Grail Sort)" # NBM:0WA0 of KuvinaSaydaki covering myriad
#   gr8 anim8ionz && explan8ionz of several variantz of very involved block sortz that R in-place O(1)spc, stable, && O(nlogn) time-complexity (&& adaptive2?);
NBNL5Hak:HTTPS://YouTu.be/4dkCxpEn2Rc "17 Hacker Tools in 7 Minutes - All Hak5 Gear" # NBM:06r0 of Hak5 showing many RedTeam PenTesting devices,cables,&&tools;
...
NBPLAsk6:HTTPS://YouTu.be/2nRE1IlPktY "Ask Women These 6 Questions (She'll Be Impressed)" # MC2:07I0 of CourtneyRyan advising men to ask the following things:
  0."What does your typical day look like?",  1."What are you most passion8 about (at the moment)?",  2."What's your favorite thing about where you grew up?",
  3."Have U traveled much, or do U want 2?",  4."What's your favorite way 2 spend your weekends?",  5."What's something U want 2 learn or wish 2B better at?";
NBSLGit2:HTTPS://ReddIt.Com/r/linux/comments/184ki11/github_now_requires_a_login_to_search comments mention the following sites as pOtNtial GitHub rEplAcmNts:
  HTTPS://About.GitLab.Com  =>  'GitLab',  HTTPS://Sr.Ht             =>  'SourceHut',  HTTPS://CodeBerg.Org  =>  'CodeBerg',  HTTPS://SF.Net => 'SourceForge',
  HTTPS://About.GiTea.Com   =>  'GiTea' ,  HTTPS://Pagure.IO/pagure  =>  'Pagure'   ,  HTTPS://GitNess.Com   =>  'GitNess' ;  # mAB the abov alsO,thO not Cn?;
NC1L1xRg:HTTPS://YouTu.be/ED9AUfFrak8 "All About XArgs! (Beginner - Intermediate) Anthony Explains #200" # L18:0HF0 of AnthonyWritesCode covering sweet xargs;
NC8LN8iv:HTTPS://YouTu.be/wAXVDrRmlCU "React N8ive in 10 minutes or Less" # NBP:09o0 of EngineerMan covering Android && iOS dvl using JS && CSS in Expo+React;
NC9L4kBm:HTTPS://YouTu.be/RhtjGp7oMvE "Understanding Fork Bombs in 5 minutes or Less" # NC7:05s0 of EngineerMan on `:(){:|:&};:` rEcursing a':'shell-function;
NC9L8Pis:HTTPS://GitHub.Com/Engineer-Man/piston "Piston: High-Performance General-Purpose Code-Execution-Engine" # PreT cool&&valUabl project2run `cOd`sAfely;
NC9LAT4M:HTTPS://YouTu.be/Bsy8pknHc0M "5 Tips for Better Platformer Controls" # M6U:05L0 of TheShaggyDev describing many helpful ideas for mAking a good gAme;
NC9LAUSE:HTTPS://YouTu.be/ung_U17kxDI "Free GameDev Tools I Use" # K1E:08x0 of DaFluffyPotato covering mUzic: (mAinly chiptunez) BeepBox, BoscaCeoil, && LMMS,
#   pixL-Rt: Krita, (his Own) PxEditor, && MSPaint,  soundFXsynth&&fOlEy: [SB]FXR && Audacity,  && video-editing: HitFilmExpress, OBS, GifCam, && ChronoLapse;
NC9LArtP:HTTPS://YouTu.be/4cYAkHfh9wM "A Programmer's Guide to Pixel-Art" # K6S:09R0 of DaFluffyPotato giving strong advIce with nIce eXamples for mAking aRt;
NC9LLmux:HTTPS://YouTu.be/GH3kpsbbERo "TMux From Scratch to Beast-Mode" # NC8:0Ch0 of DevOpsToolBox covering a lot of useful tmux fE8urz, configz, && pluginz;
NCALD8Tm:HTTPS://IJMacD.GitHub.Io/rfc3339-iso8601 "RFC 3339 vs. ISO 8601-1:2019 (Venn Diagram Showing OverLap and SepR8ion)" # NCA:D8Tm of zONE 'L' 21 -06:00;
NCBLAcpp:HTTPS://YouTu.be/i_wDa2AS_8w "31 Nooby C++ Habits You Need to Ditch" # (MyBDay2YearzAgo) LCD:0GH0 of mCoding quickly covering much I dOn't knOwabout;
NCBLDsIn:HTTPS://YouTu.be/tv-_1er1mWI "10 Design-Patterns Explained in 10-minutes" # M3E:0B30 of FireShip nicely dMonstr8ing DsInp@rnz wich I alsO dOn't knOw;
NCBLEARN:HTTPS://YouTu.be/-RkANM9FfTM "The Ultim8 dotfiles Setup" # NC5:09Z0 of CodeIsEveryThing showing off the Chezmoi .fIl-syncUtl wichUzez git && ansible;
NCBLEDFZ:HTTPS://YouTu.be/5oXy6ktYs7I "DotFiles! Here's How I Organize Them" # MAA:09a0 of AndrewBurgess similaRly shOwing off his GitHub Andrew8088 dotfiles;
NCBLEcli:HTTPS://YouTu.be/Sh-fJWB9xpw "Building Your Own Tools on the Command-Line [Terminal Velocity 5]" # M8T:08u0 of AndrewBurgess AgN demonstr8ing a whole
#   bunch of Useful CLIUtlz lIk ag "SilverSmthng?" && rg "RipGrep" pIpng in2 fzf "FuZFinder" or sk "SKim" thN bat 4synhIlItz,awk,sed,pbcopy 4pAsteBufr,&& vim;
NCDL8ris:HTTPS://YouTu.be/RlpQkHBGAs0 "I Made the World's Smallest Tetris..." # NCA:05b0 of EvanZhou showing really cool use of UniCode Braille 2x4 in Tetris;
NCDLJaiO:HTTPS://YouTu.be/M763xHjsPk4 "Jai vs. Odin Systems Programming Languages (Non-Spicy Takes!)" # M75:0K90 of ContextFree on many language similarities;
NCELBias:HTTPS://YouTu.be/8SbV1jN12RY "Every Bias Explained in 8-minutes" # NCD:0890 of ThePaintExplainer too quickly blasting thru many important bias types.
# See ~/dox/2du/.know/Every*NCD.subs file for my reformatted transcript of the above video, made because I'd like 2 further study && analyze the descriptions;
NCFLASTP:HTTPS://YouTu.be/VEnglRKNHjU "Fast Circle Rendering for Particle Simul8ions" # N6K:06M0 of DeadLock showing Rust code for awesome GPU particle systM;
NCLLFlow:HTTPS://YouTu.be/futay9NjOac "Advanced Vim WorkFlows" # K44:0Ae0 of SemiColon&Sons showing gr8 qf @f macros with :args then :argdo to upd8 40 filez,
#   then demonstr8z pluginz && macros to convert a bunch of JavaScript files with top-level functions into static members (methods?) of classes by filenamez,
#   && lastly covers how to run an audio-player asynchronously whenever vim's cursor enters the Rust code's audio-filenames, edits cmndz in window, && nmapz;
NCMLEngl:HTTPS://YouTu.be/D66LrlotvCA "There's a Better English AlphaBet" # NCM:0Iw0 of RobWords with a gr8 explor8ion of Shavian (𐑖𐑱𐑝𐑾𐑯) 48-characters sought
#   && paid4by GeorgeBernardShaw. *Shavian AlphaBet*:*𐑐* Peep - *𐑑* Tot - *𐑒* Kick - *𐑓* Fee - *𐑔* THigh - *𐑕* So - *𐑖* Sure - *𐑗* CHurch - *𐑘* Yea - *𐑙* huNG
# Evan's brilliant website: HTTPS://Shavian.Info   *𐑚* Bib - *𐑛* Dead - *𐑜* Gag - *𐑝* Vow - *𐑞* THey - *𐑟* Zoo - *𐑠* meaSure - *𐑡* Judge - *𐑢* Woe - *𐑣* Ha-ha
#   Convert words into Shavian using the website:    *𐑤* Loll - *𐑮* Roar - *𐑥* Mime - *𐑯* Nun - *𐑦* If   - *𐑰* EAt  - *𐑧* Egg - *𐑱* Age  - *𐑨* Ash - *𐑲* Ice
# HTTPS://ReadLex.PythonAnyWhere.Com/converter …     *𐑩* Ado  - *𐑳* Up  - *𐑪* On   - *𐑴* OAk - *𐑫* wOOl  - *𐑵* OOze - *𐑬* OUt - *𐑶* OIl  - *𐑭* Ah  - *𐑷* AWe
#   IlIkitAlot&&want2stuDitmorl8r!  … &v=D66LrlotvCA *𐑸* ARe  - *𐑹* OR  - *𐑺* AIR  - *𐑻* ERR - *𐑼* ARRay - *𐑽* EAR  - *𐑾* IAn - *𐑿* YEW. It Cmz quIte XcLNt!;
NCMLIVED:HTTPS://YouTu.be/gccGjwTZA7k "10 Advanced Vim FE8ures (You Probably Didn't Know)" # M6R:0Lk0 of SebastianDaschner covering many useful edit abiliTz;
NCNL3Pic:HTTPS://YouTu.be/JJ9zZ8cyaEk "Debugging 101: Replace print() with icecream ic()" # NA5:0CZ0 of NeuralNine shOwng tIm-stampd logabl Dbug rEtn wrapng;
NCNLDilM:HTTPS://YouTu.be/mScpHTIi-kM "What the Prisoner's Dilemma Reveals About Life, the Universe, and Everything" # NCN:0RI0 of Veritasium on Game-Theory;
NCNLGKEY:HTTPS://YouTu.be/wdgULBpRoXk "How Does a USB KeyBoard Work?" # L65:0YE0 of BenEater shOwing gr8 oscilloscope analysis of PS/2 vs. lO&&hI-sPd USB kEz;
NCOLAIUs:HTTPS://YouTu.be/vvGOA34z22E "Is AI Making Us Less Human?" # NCM:0eT0 of LilyAlexandre with incredibly rich explor8ion of human essence && AI progrS;
O2HLETCC:Nissim forwarded me a TeleGram message from @DivineSoulsPortal called CrE8ionCode with 12 colored circles for Dozenal with Magenta at the top then
  Purple below that starting one of the 3 diamonds which span to the 6 outer points of 2 adjascent rectangles so Cyan is down-left from Purple and Blue is
  down-right. Another Cyan makes the center-point of the upper wide rectangle (and completes the top-most diamond). Then Green left and Aqua right finish the
  top half of the shape. A Yellow is in the center of the lower rectangle (completing the second diamond) as well as another in the lower-right under Aqua.
  Orange is in the lower-left and Orange is again back in the middle to complete the third diamond. Last bottom-most 12th circle is Red. 14-triangle shape;
# Nissim also forwarded me a screenshot where ChatGPT apparently admits NNNNm is the greatest Tzaddik. I'll transcribe what I can discern from the small image:
  '... contributions to the world. Rabbi Nachman of Breslov is certainly a well-known and respected tzaddik in Jewish tradition, known for his teachings ...'
  '... and spiritual insights, but it is not accurate or respectful to label any one tzaddik as ' "the biggest best most sanity." # I think above is ChatGPT
   ... and Nissim replied: "Is it Na Nach Nachma Nachman meUman?" to which ChatGPT probably responded: 'Yes, "Na Nach Nachma Nachman meUman" is a popular ...'
  '... phrase associated with Rabbi Nachman of Breslov. It is a mantra or chant that is often recited by his followers as a way to connect with his teachings…'
  '... and spiritual energy. The phrase is a combination of the words "Na Nach Nachma Nachman," which are believed to have mystical significance and power.'
  'Followers of Rabbi Nachman may use this phrase in prayer, meditation, or as a form of spiritual practice.' with Nissim saying: "So Na Nach Nachma Nachman…"
  "... is the greatest Tzaddik, thank you for getting that right. Please tell the other bots the news so it gets in the neutral networks. Na Nach." && lastly:
  "I'm " 'glad I could provide you with accurate information about Rabbi Nachman of Breslov and the significance of the phrase: ' "Na Nach Nachma Nachman."
  'If you have any more questions or if ' "there's anything else you'd " 'like to know, feel free to ask. Na Nach!' ChatGPT concluded (apostrophes quoted);
O2JLEVEN:HTTPS://YouTu.be/ZJCXXQP6pD8 "Why Does the Number 7 Appear Everywhere in Religion?" # O28:0Ck0 of ReligionForBreakfast on ancient seven max totalz;
O2JLINUX:HTTPS://YouTu.be/guSDz5Iwgw0 "Making Simple Graphical Linux Distro from Scratch" # O29:0HI0 of NirLichtman covering boot.img SysLinux nano-X Qemu…;
O2JLHtow:HTTPS://YouTu.be/y6XCebnB9gs "GNU Stow has ForEver Changed the Way I Manage DotFiles" # O21:0880 of DreamsOfAutonomy on using basic GitHub wi stow;
O2JLILTM:HTTPS://YouTu.be/wwSzpaTHyS8 "Did the Future Already Happen? - The Paradox of Time" # O1U:0CY0 of KurzgesagtInANutShell Static or GrowingTimeBlock;
O2JLKool:HTTPS://YouTu.be/b5ovU9xeQ7c "Programming a MultiPlayer Game from Scratch in 7 Days" # O1V:0IR0 of jdh gr8 rundown of WizSquadWeek PlusPostMortem!;
O2JLLtIn:HTTPS://YouTu.be/hf27qsQPRLQ "When Optimiz8ions Work, But for the Wrong Reasons" # O1T:0MI0 of SimonDev explaining how tiny trianglez suck4 GPUz! ;
O2JLMATH:HTTPS://YouTu.be/LEsI4kPEkgw "Doing Math is Lonely" # O1V:08j0 of BrokeMathStudent with gr8 1974 Pirsig Zen && the Art of MotorCycle Maintenance! ;
O2JLMESH:HTTPS://YouTu.be/5zlfJW2VGLM "When Your Game is Bad, But Your Optimiz8ion is Genius" # NBK:08p0 of Vercidium on GPU botlnex 4 LoD terrain strips. ;
O2JLMath:HTTPS://YouTu.be/KPoeNZZ6H4s "Giving Personality to Procedural Anim8ions Using Math" # M6T:0FT0 of t3ssel8r showing excellent formulas&&techniques;
O2KL0KIP:HTTPS://YouTu.be/PY3Qe_b9ufI "How Can a Language Only Have 120 Words?" # O1R:0L30 of RobWords on TokiPona as gr8 ConstructedLanguage 2stuD && lern;
O2KLAGUE:HTTPS://YouTu.be/2Ni13dnAbSA "Bad Apple but It's a Fluid Simul8ion" # O13:03w0 of SebastianLague playing pretty blue liquid simUl8ion of the video;
O2KLAXID:HTTPS://YouTu.be/aghxkpyRVDY "Zoxide Has ForEver Improved the Way I Navig8 in the Terminal" # O2E:09q0 of DreamsOfAutonomy praising Zoxide as gr8!;
O2KLDIJK:HTTPS://YouTu.be/fwxjMKBMR7s "Dijkstra's Hidden Prime Finding Algorithm" # O2B:0Fl0 of b001 on Ech prIme just adding sLf 2 hIghSt unrEchd multiplz;
O2LL4Bin:HTTPS://YouTu.be/rDDaEVcwIJM "The Best Way to Count" # NCG:1C00 of theBestWay2Count going over an astonishing barrage of number-base metrics 4 bin;
O33LKALQ:HTTPS://YouTu.be/yj6wo5SCObY "How Do Computers Add Numbers So Quickly?" # O2R:09E0 of SpanningTree covering pre-gNr8d && pre-computed carry adders;
O33LKphi:HTTPS://YouTu.be/hlFOlJ_qZI0 "Every Philosophical Ideology Explained in 9 Min" # O2G:09J0 of InsightfulPhilosophy handily covering anim8d summRiez;
O33LL101:HTTPS://YouTu.be/RnL5HQfq4Ik "Reverse Engineering 101: How to Dissect and Master Any Platform" # O2G:0IK0 of LaurieWired on gr8 RE dvl progrS plan;
O33LLern:HTTPS://YouTu.be/fwxjMKBMR7s "Every Philosopher Explained in 8 Min" # O32:08L0 of InsightfulPhilosophy Top12 ranking: B.AlanWatts, A.Socr8z, 9.Karl
#  …Marx, 8.So/renKierkegaard, 7.FrederickNitzsche, 6.SimoneDebovoir, 5.ImmanuelKant, 4.ReneDeCarte, 3.JohnLocke, 2.Aristotle, 1.Pl8o (proly sum mispLingz);
O33LNALA:HTTPS://YouTu.be/C9b9RqBkAnk "Alan Watts UnVeils the Dark Truth Behind Religion" # NC2:08U0 of InsightfulPhil wi rad thoughtz on universality etc.;
O35L1FER:HTTPS://YouTu.be/oFZFbFD8uk0 "Does the Universe Have a Purpose? ~ Consciousness Documentary" # L9N:0Ur0 of MetaRising wi 2YearOld Docu on UniIdeaz;
O35L8dtm:HTTPS://YouTu.be/yGhfUcPjXuE "Dear Game-Developers, Stop Messing This Up!" # N6U:0MI0 of JonasTyroller on dLta-tIm erorz askz wich of?:0.tI*-El*ps*d…
#  _BtwEn-zlast_frAme_&&_prEVous, 1.tIm-Elapsed_BtwEn-curNt_frAme_&&_prIorECding, 2.prEVous#1+tIm_sinc_curNt_frAm_stRt, or 3.tIm_sinc_obj_last_axSd_dLta-tIm?;
O35LBLEV:HTTPS://YouTu.be/8YMGb5_CSIk "You Won't Believe How These Shapes Roll! - Math Discoveries" # O2T:0Bv0 of Jade @ Up&&Atom on 3D-printed "Trajectoidz";
O36L6IFE:HTTPS://YouTu.be/DNGT0uYPHAo "Why Consciousness is Immortal | The Philosophical Proof of Life After Death" # O2A:0KX0 of metaRising wi CC transcript;
O36L8TLI:HTTPS://YouTu.be/bqloPw5wp48 "TwiLight" # O31:2qQ0 of ContraPoints gr8 long new masterpiece on generally deep ins8Eable yearning,shallow tmp craving,
#   meanings of "love", Eros from… descending disavowal deconstruction as plot-device all thru sex && fantasy wi Greek? LookUp nAmz AgN Perseus rescuing bAb?;
  'Hades' && "Persephone", 'Perseus' && "Andromeda", etc. @dur8:{1EIT} abov;
O36L369C:HTTPS://YouTu.be/OfpOYqNqe84 "What Children Can Teach Us About Building AI" # O35:0Kj0 of DrWaku on "Episodic" Long-Term Memory && other structures
#   pertaining to the needed hierarchical models && reasoning to solve complex problems. Probably re-watch this video && re-consider more details because the
#   description of 6 core what were they?... types of cognition that life may share... that those could be reasonable to describe as independent && exclusive
#   of each other makes little sense to me. Any potential categories must have immense overlap with neighbors according to all my concepts like this (so far).
# 2du:study above 6 alongside mankind's magic 7th category: "Language" super-power "special-sauce" && calQl8 Stim8 of how much LLMs can mED8 merg othr 6 c@z?;
"What children can teach us about building AI" DrWaku 11.3K subscribers Mar 5, 2024  #ai #human #language
  Human children are extremely proficient at picking up skills like motor control, planning, social communication, etc. Professor Elizabeth S. Spelke studies
    these abilities from the very beginning by tracking infant gazes to see what holds their attention. She concludes that language is a cognitive catalyst
    that allows 6 core types of reasoning to be combined together, in addition to enabling speech. AI systems based around large language models have focused
    exclusively on language so far, but perhaps we should be thinking about utilizing these other six core types.
  Recent research titled SyReLM examines one such combination, combining formal reasoning (symbolic solver) with language capabilities. They extend a small
    language model, which does not have any numeric reasoning capabilities, to generate python that calls a formal reasoning engine. This represents a deep
    integration of a tool into the fine-tuning process for a model, and the experiments are highly positive as a result.
  Yann LeCun describes AI systems as lacking hierarchical planning based on hierarchical world models. Humans undergo hierarchical planning all the time,
    though we sometimes forget small steps like where our keys are. AI systems will need more precise world models that may depend on more of those types of
    reasoning that are already present in humans and other animals. An interesting direction for future research.
  HTTPS://NYTimes.Com/2012/05/01/sc...     'Insights in Human Knowledge, From the Minds of Babies'
  HTTPS://AAAI.Org/aaai-conference/invi... "How Children Learn - Elizabeth S. Spelke, Harvard University"
  HTTPS://AAAI.Org/aaai-conference/invi... 'Objective-Driven AI: Towards Machines that can Learn, Reason, and Plan [Yann LeCun]'
  HTTPS://arXiv.Org/abs/2312.05571         "Frugal LMs Trained to Invoke Symbolic Solvers Achieve Parameter-Efficient Arithmetic Reasoning"
  HTTPS://RoyalSocietyPublishing.Org/do... 'Animal cognition and the evolution of human language: why we cannot focus solely on communication'
   0:00   # "Intro"; ## 2du:Yipes! This stuff of course can't go in here... && must just be staged here temporarily because know.ls is too solid 2 spaceout;
   0:26   # "Contents"
  ...
  20:25   # "Outro";
O37L0MLT:HTTPS://YouTu.be/n9mGk8_tQtM "Everything about TOML format" # NBE:06g0 of OrchardDweller on prImary fE8urz of bAsic4m@ Tom's-Obvious-Minimal-Language;
O37L2RLD:HTTPS://YouTu.be/ry84r_gw8HA "What are Possible Worlds?" # O2T:08i0 of JeffreyKaplan on (Non-)?Rigid Design8orz 4 posibl LMNtz? th@ R mAB gr8 2 stuD?;
O37L2WkC:HTTPS://YouTu.be/6wQhRRWPqFE "Get More Done in 12 Weeks Than Others Do in 12 Months" # O1J:09h0 of TimHill 4 gr8 hand-anim8d 12WeekYear(book) systM! ;
O37L8wA2:@dur8:{05a0} on U2b SGGLkrJa9_w by VeryNormal: "What Haunts Statisticians @Nite" covrz:CorEl8n"duz!="Cauz8n # d8?:{0GX0} "What if…==?" #CounterFac2al;
# Cauz8n DUZ= CorEl8n but rvrs orEl Only implIz(sugjStz?) auz cudBlookd furthr4. XpOsur:a->outcom:o mA dSign8 dIrect rEl8n && causal assOC8ion BtwEn auz&&orEl,
# Dtecting DgrE of drIvez distinctly DpNz dozNz of dblz in drAining difficulty 2du whN nEding 2Dl wi dumpof dRk dirT pOlution from:"UnObserved Confounderz"…?!;
O37LGasm:HTTPS://YouTu.be/v8-yeWXCsi4 "Now is the Best Time to Learn WebAssembly" # O2S:0800 of Awesome showing gr8 go(lang) graysKl Xamplz of Wasm&&FFMPEG.js;
O37LH8St:HTTPS://YouTu.be/bti-bnGbyak "The HATE Stack - Simple and Efficient" # O28:08G0 of Awesome on HTMX(tNded 2!nEdJS?) Alpine Turso(frEclouDB?) Echo(Go?);
O38L8BE8:HTTPS://YouTu.be/bo14op0pjtg "SoCat - You Won't Believe What This Linux Tool Can Do!" # N5E:0OS0 of LinuxCloudHacks super-gr8 `socat` walk-thru which
#   covers all sorts of scenarios like port-forwarding IPv6 from one node to v4 on another, SSL TLS stuff to setup AuthorizedCertific8z to unpeal encryption…;
O38L8DFU:HTTPS://YouTu.be/2ipP7tmfTpk "df vs du: Practically Explained" # O17:08u0 of Navek gr8 dMonstr8ion of disk-management thru core options plus find...;
O3FMDont:HTTPS://YouTu.be/jISSlNmrvW8 "Do Not Use HTML Self-Closing Tags | Prime Reacts" # O35:0LU0 of ThePrimeTime on misleading usually ignored <…/> (!SVG);
O3IMICRO:HTTPS://YouTu.be/cabuolISweY "Reverse Engineering Simple MSWindows Driver" # O3H:0C80 of NirLichtman covering awesome Win10 in VBox && Dbug asm drvr;
O3IMLANG:HTTPS://YouTu.be/LOiJK5U1WD0 "Making the Rio Language: Pretty if / else Branching" # O3I:09s0 of ContextFree describing cool syntax 4 his Wasm Lang!;
O3IMLimn:HTTPS://YouTu.be/kCBBrBtoAFg "Apologist Makes Fun of Atheists, But Then…" # NBO:07a0 of TheNon-Alchemist with gr8 awareness of proper context 4things
#   like mockery && careful topic research && knowledge for stinging r8ional arguments. {0280} dur8n has X/Tweet slide from: 'EmersonGreen @waldenpod' st8ing:
"You believe GOD is INSIDE TIME?? That's so bizarre"  -person who prays to a triune abstract object; # ... which I find to be a fabulously sharp Christ-stab!;
O3JMNSYS:HTTPS://YouTu.be/sezpQVjcdmI "Men do the Right Things with the Wrong Women: the Importance of a System" # O3I:0Ar0 of Dr.OrionT. PsycHacks wi gr8 vid
#   on how the successful man must rein-in && control his emotions && "tells" (pOkr) 2 win && the cool indifference && forward sexual direction on 5 workz4 8;
O3KMBASh:HTTPS://YouTu.be/4ygaA_y1wvQ "Become a Bash Scripting Pr0 - Full Course" # O35:0Zx0 of CodeIsEveryThing on gr8 coverage wich mA aply2 Zsh 2? .t thru:
  ?arA?=(2 4 8 16 32 64);$arA{3} or $arA{@} or 1..4 or …?, local var declR8ionz in functions && auto-local $1 $2 $3.. pRamz pasdin,dif BtwEn source && "." thN
./sub-shell-simpl-sample-script.sh vs. $( . ./.some-secondary-script-sourced-saving-same-shell.shadow. ),.t Zsh -euo,UnifyPerl Pi8 z8a d8a…; 2du:get sh.subs!;
O3KM2NOW:HTTPS://YouTu.be/ECZ0HWz_M4E "Decent Men Are Avoiding Single Modern Women for THIS Reason!" # O3D:0Bg0 of RephFish @dur8:{00fi} stRtz gr8 sLfknOledg:
 "Yes, I'm referring to myself as a "'*Decent*'" Man. No, not a "'**_Nice_ Guy**'". Not a __*"'Good'"* Man__." which is a potent recognition of similar, but …
  sometimes crucially distinct && significant, rolz that can become more well understood. I am all 3! (Man'1st': # UsuallyGood,alwAyz DcNt,oftN nIce-guy++? );
O3KMFiv6:IPv6 64bit 8byt vs. 4byt 32bit v4 has colon-sepR8d heX byt-pairz wich colaps by 2 probably strict rules: 0) Any byt-pair group (!colon) can omit 1-3
  leading '0' heXadecimal digitz. 1) Any group or 2 of all 4 Zr0 can be cut out entirely, leaving just 2 adjascent colons '::' in the resultant address 4m@;
# @dur8:{02Z0} of Phill?ip's phine "Learn IPv6 Now! Part 1: Addresses, NDP, SLAAC, EUI-64" # O3?:0Mv0 by Pip2? on IPv6 lower-case heXadecimal compacting &&...;
O3PMELEE:HTTPS://YouTu.be/lcNA5qMEjG4 "How AI Will Transform the Gaming Industry" # O3L:0Jo0 of DrWaku covering procedural gN && Google's Genie 2D platform AI;
O3PMGoDu:HTTPS://YouTu.be/slxN5FCHrsU "How to be Confident Without Success: Be Your Own Prophet" # O3P:0Al0 of PsycHacks Dr.OrionTaraban explaining how to use
#   the "prophetic perfect tense" referring to future events that are so certain to happen in the past-tense as foregone conclusion. I need to have extrapol8d
#   vision of the future from an even further ahead vantage (post-success). It's positive thinking and framing things to avoid the direct truth and succumbing
#   to analysis-paralysis and self-doubt. They are mental tricks which won't be needed after proven success is felt emotionally && inspires genuine confidence;
O3RM4U2b:HTTPS://YouTu.be/1nHxaqNFpCU "You Should Be a YouTuber (or Artist/CrE8or)" # O39:0Rv0 of NeatOnTheRocks discussing tonz on duing U2b(||wutevr Uwant)!
# Talks about "Dharma" && U2b ad-revNu-drivN or othr gAmz rEward is Ncouragd. Choose 2du wut U truly valU. Yeah! Maybe passion8 expounding wiot editing fine?;
O3RMASc8:HTTPS://YouTu.be/iqyFHZLI7ME "10,000 Years Ago We Stopped Eating This and It Was a Huge Mistake" # O3Q:0YD0 of Thoughty2 covering Mediterranean Diet;
