# H7PMBZUM: Oct::p8::psps.pm crE8d by PipStuart <Pip@CPAN.Org> as "PiP'S httpS://ScreePS.com Play Simul8or" in my new p8:"Play simul8ion" namespace;
...
package     Oct::p8::psps; # originally derived from d8.pm to attempt a Perl port of the public Screeps API for offline analysis && online code gener8ion
use strict; use warnings;use utf8;use v5.10;
#equire       Exporter  ;
#se base qw(  Exporter );
#se vars qw( @EXPORT   ); #$AUTOLOAD

#equire     Oct::d8::fldz; # maybe l8r sub-packagez will similarly require && use base psps (which is planned to be akin to Screeps' global Game object)
#equire                        Exporter;
#se base qw(Oct::d8::fldz);#porter);
...
# Oct::p8::psps object constructor as class method or copy as object method. This is planned to be very similar to Screeps global top-level Game object.
sub new{
  my($nvkr,$ityp,$idat)=@_;
  my $nobj=ref($nvkr);
  my $clas=$ityp;
...
Oct::p8::psps - PiP'S ScreePS Perl Simul8or

=head1 VERSION

This document8ion refers to version 0.0 of Oct::p8::psps, which was released on
.

=head1 SYNOPSIS

  use       Oct::p8::psps;use v5.10;
  my  $ps = Oct::p8::psps->new();
...
Oct::p8::psps' constructor...

=head1 NOTES

I hope you find Oct::p8::psps useful.

=head1 CHANGES

Revision history for Perl extension Oct::p8::psps:
