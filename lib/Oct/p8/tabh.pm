# H82MKeXY: Oct::p8::tabh.pm crE8d by PipStuart <Pip@CPAN.Org> to be a class for Tied Array Binary Heap objects with arrayrefs of [valu,noid] for A*;
...
use         Oct::a8; # needed for colr prnt
...
# Oct::p8::tabh object constructor as class method or copy as object method. First param can be ref to copy. Not including optional ref from copy,
...
Oct::p8::tabh - make Tied Array Binary Heap objects

=head1 VERSION

This document8ion refers to version 0.0 of Oct::p8::tabh, which was released on
.

=head1 SYNOPSIS

  use utf8;use v5.10;use Oct::p8::tabh;
...
Oct::p8::tabh's constructor without tying an array...

=head1 NOTES

I hope you find Oct::p8::tabh useful.

=head1 CHANGES

Revision history for Perl extension Oct::p8::tabh:
...
Please run:
  ...
  `perl -MCPAN -e "install Oct::p8::tabh"`
