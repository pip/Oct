# H83M3QqE: Oct::p8::psps::cnst.pm crE8d by PipStuart <Pip@CPAN.Org> as "Pip's Screeps Global Constants" module to export l8st copies of all Constants;
...
package     Oct::p8::psps::cnst; # originally was all exported from psps.pm but isol8d here for inclusion in any other sub-classes
...
use vars qw( @EXPORT   );
use         Oct::a8; # Compress && eXpand Base64 Room(Name|Position|Terrain) && SerializedPath
...
Oct::p8::psps::cnst - PiP'S ScreePS Perl Simul8or global CoNSTants

=head1 VERSION

This document8ion refers to version 0.0 of Oct::p8::psps::cnst, which was released on
.

=head1 SYNOPSIS

  use Oct::p8::psps::cnst;use v5.10;
...
use Oct::p8::psps::cnst to import all the l8st Global Constants into your local namespace.
...
Revision history for Perl extension Oct::p8::psps::cnst:
...
Please run:
  ...
  `perl -MCPAN -e "install Oct::p8::psps::cnst"`
