# L43MEANS:Dockerfile crE8d by JohnBeppu-san <Beppu@CPAN.Org> for Pip's GitHub Oct;my $d8VS='L8NM0Uni';
...
# Copy core Oct files into: tst's $HOME;  # Above should call host something other than Docker's default hexadecimal name for the container image made;
...
#          -c 'echo "Welcome to PipStu's: Oct! Please try2run: ec \$R Red \$O Orn \$Y Yel \$G Grn \$C Cyn \$B Blu \$M Mgn \$P Prp \$z zero-Reset" '
# Build:  `dkrb`
#   docker build .  -t oct
